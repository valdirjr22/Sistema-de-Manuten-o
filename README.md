...
<head>
    ...
    <style>
        ...
        input[type="text"]:focus, select:focus, input[type="date"]:focus, input[type="time"]:focus, textarea:focus {
...
<div id="cadastro-page" class="page active">
    ...
    <button class="button animate__animated animate__fadeIn animate__delay-2s" onclick="showListPage()">Ver Lista de Equipamentos</button>
</div>

<div id="lista-page" class="page">
    <h1 class="animate__animated animate__fadeInDown">Lista de Equipamentos</h1>
    <button class="button animate__animated animate__fadeIn animate__delay-1s" onclick="showCadastroPage()">Voltar ao Cadastro</button>
...
<script>
    ...
    let equipmentList = loadEquipmentList();

    function showListPage() {
        document.getElementById('cadastro-page').classList.remove('active');
        document.getElementById('lista-page').classList.add('active');
        updateEquipmentTable();
    }

    function showCadastroPage() {
        document.getElementById('lista-page').classList.remove('active');
    ...
    function updateEquipmentTable(filteredList = equipmentList) {
        ...
        filteredList.forEach((equipment, index) => {
            ...
            const maintenanceCell = row.insertCell(4);
            maintenanceCell.innerHTML = `
            ...
            `;
            const maintenanceSelect = maintenanceCell.querySelector('select');
            maintenanceSelect.value = equipment.maintenanceType || '';
            const detailsDiv = document.getElementById(`maintenanceDetails${index}`);
            detailsDiv.style.display = equipment.maintenanceType ? 'block' : 'none';
            ...
            row.insertCell(6).innerHTML = `
                ...
                <button class="button" onclick="showFullReport(${index})">Ver Relatório Completo</button>
